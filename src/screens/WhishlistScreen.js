...
import { View, FlatList, Image, TouchableOpacity, StyleSheet, StatusBar } from "react-native";
...
const styles = StyleSheet.create({
  card: { width: "47%", backgroundColor: "#fff", borderRadius: 18, elevation: 2, shadowColor: "#ccc", shadowOpacity: 0.2, shadowRadius: 4 },
  imageContainer: { position: "relative" },
  image: { width: "100%", height: 130, borderTopLeftRadius: 18, borderTopRightRadius: 18 },
  heartButton: { position: "absolute", top: 10, right: 10, backgroundColor: "white", padding: 8, borderRadius: 20, elevation: 3 },
  info: { padding: 10 },
